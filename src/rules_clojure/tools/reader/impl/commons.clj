...
(ns rules-clojure.tools.reader.impl.commons
  (:refer-clojure :exclude [char])
  (:require [rules-clojure.tools.reader.reader-types :refer [peek-char read-char]]
            [rules-clojure.tools.reader.impl.errors :refer [reader-error]]
            [rules-clojure.tools.reader.impl.utils :refer [numeric? newline? char]])
