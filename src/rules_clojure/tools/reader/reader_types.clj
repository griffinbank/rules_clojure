...
(ns ^{:doc "Protocols and default Reader types implementation"
  ...
  (:require [rules-clojure.tools.reader.impl.utils :refer [char whitespace? newline? make-var]])
...
(extend-protocol ReaderCoercer
  ...
  rules_clojure.tools.reader.reader_types.Reader
  (to-rdr [rdr] rdr)
  String
...
(extend-protocol PushbackReaderCoercer
  ...
  rules_clojure.tools.reader.reader_types.PushbackReader
  (to-pbr [rdr buf-len] (push-back-reader rdr buf-len))
  String
...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? rules_clojure.tools.reader.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? rules_clojure.tools.reader.reader_types.PushbackReader rdr))
           (not (instance? rules_clojure.tools.reader.reader_types.StringReader rdr))
           (not (instance? rules_clojure.tools.reader.reader_types.InputStreamReader rdr))
