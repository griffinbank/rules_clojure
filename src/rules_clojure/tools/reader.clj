;; vendor'd to avoid interfering with user versions
...
(ns ^{:doc "A clojure reader in clojure"
  ...
  (:require [rules-clojure.tools.reader.reader-types :refer
            ...
            [rules-clojure.tools.reader.impl.utils :refer :all] ;; [char ex-info? whitespace? numeric? desugar-meta]
            [rules-clojure.tools.reader.impl.errors :as err]
            [rules-clojure.tools.reader.impl.commons :refer :all]
            [rules-clojure.tools.reader.default-data-readers :as data-readers])
  (:import (clojure.lang PersistentHashSet IMeta
                         RT Symbol Reflector Var IObj
                         PersistentVector IRecord Namespace)
           rules_clojure.tools.reader.reader_types.SourceLoggingPushbackReader
